...
progress "Setting computer name to ‘$COMPUTER_NAME’"
sudo scutil --set ComputerName "$COMPUTER_NAME"

progress "Configuring general UI preferences"
...
progress "Configuring energy saving"
...
progress "Configuring screen and screenshots"
...
progress "Configuring Time Machine and Activity Monitor"
...
progress "Configuring TextEdit and Disk Utility"
...
progress "Configuring Mac App Store and software updates"
...
printf "\n\033[1;32mDone! %d/%d steps completed. Restart your Mac for all changes to take effect.\033[0m\n" "$STEP" "$TOTAL"